...
def show_boxes_batch(sample_batched):
    ...
    for i in range(batch_size):
        axis = plt.subplot()
        rect = patches.Rectangle((boxes_batch[i, :, 0], boxes_batch[i, :, 1]), boxes_batch[i, :, 2]-boxes_batch[i, :, 0], boxes_batch[i, :, 3]-boxes_batch[i, :, 1], linewidth=1, edgecolor='r', facecolor='none')
